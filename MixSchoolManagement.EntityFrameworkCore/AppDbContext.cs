...
using MixSchoolManagement.Infrastructure;
using MixSchoolManagement.Infrastructure.EntityMapper;
using MixSchoolManagement.Models;
using MixSchoolManagement.Models.BlogManagement;
using MixSchoolManagement.Models.Blogs;
using System.Linq;

namespace MixSchoolManagement.EntityFrameworkCore
{
